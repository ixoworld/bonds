...
func testnetCmd(ctx *server.Context, cdc *codec.Codec,
	...
	cmd := &cobra.Command{
		Use:   "testnet",
		Short: "Initialize files for a Bondsd testnet",
...
Example:
	bondsd testnet --v 4 --output-dir ./output --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "bondsd",
		"Home directory of the node's daemon configuration")
	cmd.Flags().String(flagNodeCLIHome, "bondscli",
...
func InitTestnet(cmd *cobra.Command, config *tmconfig.Config, cdc *codec.Codec,
	...
	bondsConfig := srvconfig.DefaultConfig()
	bondsConfig.MinGasPrices = minGasPrices
	...
	for i := 0; i < numValidators; i++ {
		...
		// TODO: Rename config file to server.toml as it's not particular to Bonds
		// (REF: https://github.com/cosmos/cosmos-sdk/issues/4125).
		bondsConfigFilePath := filepath.Join(nodeDir, "config/bondsd.toml")
		srvconfig.WriteConfigFile(bondsConfigFilePath, bondsConfig)
	}
